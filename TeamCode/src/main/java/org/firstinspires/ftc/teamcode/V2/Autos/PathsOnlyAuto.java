...
public class PathsOnlyAuto {
    ...
    PathsOnlyAuto(Follower follower, IntakeSubsystem intake, SpindexerSubsystem spindexer,
        ...
        if(startClose) {
            ...
            poses.add(new Pose(120.0, 84.0, 0)); // after pickup
            ...
            paths.add(follower.pathBuilder() // go to second shoot
                    ...
                    .setLinearHeadingInterpolation(poses.get(2).getHeading(), poses.get(1).getHeading())
                    .build());
        }
